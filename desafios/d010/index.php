...
<body>
    <main>
        ...
        <form action="<?=$_SERVER["PHP_SELF"]; $ano_atual=date("Y")?>" method="get">
            <label for="ano_nascimento">Em que ano você nasceu?</label>
            <input type="number" name="ano_nascimento" id="id_ano_nascimento" step="1">
            <label for="ano_futuro">Quer saber sua idade em que ano? (atualmente estamos em <?=$ano_atual?>)</label>
            <input type="number" name="ano_futuro" id="ano_futuro" step="1">
